...
-----
    ...
    python scripts/e9_directed_ablation.py --probe_weights results/probes/e8_constraint_probes/probe_weights.pt
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="results/directed_ablation/e9_directed_ablation")
